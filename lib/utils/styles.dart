...
var red = const Color(0xFF800020);

// TextStyles
TextStyle header = GoogleFonts.montserrat(
    fontWeight: FontWeight.w700, color: accent, fontSize: 36);
TextStyle subheader = GoogleFonts.montserrat(
    fontWeight: FontWeight.w700, color: heading, fontSize: 24);
TextStyle textBold = GoogleFonts.montserrat(
    fontSize: 14, fontWeight: FontWeight.w700, color: accent);
TextStyle texts = GoogleFonts.montserrat(
    fontSize: 14, fontWeight: FontWeight.w400, color: accent);
TextStyle errorText = GoogleFonts.montserrat(
    fontSize: 14, fontWeight: FontWeight.w400, color: red);